...
*/
export function
hdate_get_holyday (h:Hdate.Hdate, isDiaspora:boolean = false):number
{
  var holyday:number = 0;

  /* holydays table */
  var holydays_table:number[][] = 
  [
    [  /* Tishrey */
...
*/
export function
hdate_get_omer_day(h:Hdate.Hdate):number
{
  var omer_day:number = 0;
  var sixteen_nissan:Hdate.Hdate = new Hdate.Hdate();
